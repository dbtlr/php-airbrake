...
interface IDelayedNotification
{
    ...
    public static function createDelayedNotification($staticNotifyMethod, $xml, $apiEndPoint, $timeout, $headers, $errorMessage, $errorNotificationCallback = null, $secondaryCallback = null);
}
