...
interface IDelayedNotification
{
    ...
    public static function createDelayedNotification($staticNotifyMethod, $xml, $apiEndPoint, $timeout, $headers, $errorMessage, $dbReportClass = null, $dbId = null, $errorNotificationCallback = null, $secondaryCallback = null);
}
